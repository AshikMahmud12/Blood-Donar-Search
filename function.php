...
// connect to database
$db = mysqli_connect("localhost", "root", "", "donate_blood");
...
function register(){
	...
	global $db, $errors, $username, $blood, $email ,$area, $address, $distance, $phone,  $gender, $bday,$password_1 , $password_2, $user_type;
